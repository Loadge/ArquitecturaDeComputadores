// gcc -O0 figura1-modificado_accesos.c -o figura1-modificado_accesos-0
// gcc -O1 figura1-modificado_accesos.c -o figura1-modificado_accesos-1
// gcc -O2 figura1-modificado_accesos.c -o figura1-modificado_accesos-2
// gcc -O3 figura1-modificado_accesos.c -o figura1-modificado_accesos-3
// gcc -Os figura1-modificado_accesos.c -o figura1-modificado_accesos-4
...
/* ------------CUERPO DEL PROGRAMA----------  */
	...
	for (ii=1; ii<=40000;ii++) {
		for(i=0; i<5000;i++){
			X1+=2*s[i].a+ii; //Sumatoria en X1
			X2+=3*s[i].b-ii; //Sumatoria en X2
		}
		if (X1<X2){
			R[ii]=X1;
		}else{
